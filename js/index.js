    ...
    series: [
      {
        ...
        type: "bar",
        barWidth: "35%",
        data: [2967694.8,2848400, 481600, 1175871, 4474900,947563,573503],
        itemStyle: {
          // 修改柱子圆角
          barBorderRadius: 5
        }
...
(function() {
  ...
  var option = {
    ...
    yAxis: [
      ...
      {
        data: [11232469, 4706500, 4577000, 4859141, 438500],
        inverse: true,
        // 不显示y轴的线
        axisLine: {
          show: false
  ...
  var yearData = [
    {
      ...
      data: [
        // 两个数组是因为有两条线
        [2817000, 4143500, 7259454, 8704370, 3787459, 6334109, 4939546, 7088569, 4385056, 4560989, 6050611, 3290887],
        [4072010, 573503, 1181366, 203364, 955359, 887670, 1107758, 1763484, 4539171, 1391055, 1874750, 1232854]
      ]
    },
    {
      year: "2018", // 年份
      data: [
        // 两个数组是因为有两条线
        [2967694, 3905000, 6739068, 8068295,3698070,5776355, 4612117, 7007223, 4036632,4080564,5690732,3051891],
        [3773364, 795895, 1216938, 209648, 1176597,901738, 1239431, 2006334,4572067,1327617,1795013, 1126218]
      ]
    }
  ];
  // 1. 实例化对象
